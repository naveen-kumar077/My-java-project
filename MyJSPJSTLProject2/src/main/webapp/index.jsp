<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.sql.*,sl314.myclasses.*" isELIgnored="false"%>
...
<form action="insert.jsp" method="post">
  <fieldset>
    <legend>Insert Record</legend>
      ...
      <input type="datetime-local" id="insert-joinDate" name="joinDate">
...
<br>
  ...
  <form action="DeleteEmployees.jsp" method="POST">
  <fieldset>
